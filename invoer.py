...
def show_input_form():
    ...
    with st.expander("Input Data", expanded=True):
        ...
        st.write(f"**{civil_twilight_label}** Begin:{civil_twilight_begin}, **{civil_twilight_label}** End:{civil_twilight_end},<br>**{nautical_twilight_label}** Begin:{nautical_twilight_begin}, **{nautical_twilight_label}** End:{nautical_twilight_end}")
